...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2023 at 08:49 PM
...
(326, '2022-10-29', 'Available', 'Thesis', 'BEED', 'COMMUNICATION SKILLS OF BSIT IV STUDENTS IN J.H. CERILLES STATE COLLEGE-DUMINGAG CAMPUS.pdf'),
...
INSERT INTO `return_tbl` (`record_id`, `schoolId`, `date_today`, `penalty`, `date_borrowed`, `status`) VALUES
(325, '2023-13611', '2023-05-10', 600, '2023-04-28', NULL);
...
(12, 'test', 'test', 'test@gmail.com', 2, '09661337494', 'girl-shows-okay-sign-winks-good-job-approve-hand-symbol-simple-illustration_348404-39.webp', '2023-13611');
...
('123456', 'hannie', 'oracion', 'female.sample@nyc.com', '+639650885752 ', 'test', 'BSIT', '2023-13611');
...
ALTER TABLE `borrow_tbl`
  ...
  ADD KEY `FK_borrow_tbl` (`student_id`);
...
--
ALTER TABLE `borrowed_tbl`
  MODIFY `borrowed_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `borrow_tbl`
  ADD CONSTRAINT `FK_borrow_tbl` FOREIGN KEY (`student_id`) REFERENCES `student_tbl` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `course_tbl`
  ADD CONSTRAINT `FK_course_tbl` FOREIGN KEY (`student_id`) REFERENCES `student_tbl` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE;
